...
var removeVersionKey_1 = require("../middlewares/removeVersionKey");
            ...
            validator: function (date) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.constructor.countDocuments({
                                    appointDate: date,
                                    vet: this.vet,
                                })];
                            case 1:
...
appointmentSchema.pre(/^find/, removeVersionKey_1.removeVersionKey);
